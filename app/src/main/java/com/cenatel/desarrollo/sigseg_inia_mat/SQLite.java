    ...
    public ArrayList<String> getFormatListUniv( Cursor cursor )
    {
        ...
        if( cursor.moveToFirst() )
        {
            do
            {
                ...
                item += "Fecha de Siembra: " + cursor.getString(8) + "\r\n";
                item += "Variedad: " + cursor.getString(9) + "\r\n";
                item += "Etapa Fenologica: " + cursor.getString(10) + "\r\n";
                item += "Condicion: " + cursor.getString(11) + "\r\n";
                item += "Numero de Lote: " + cursor.getString(12) + "\r\n";
                item += "Latitud Foto Panoramica: " + cursor.getString(13) + "\r\n";
                item += "Longitud Foto Panoramica: " + cursor.getString(14) + "\r\n";
                item += "Latitud Foto Detalle: " + cursor.getString(15) + "\r\n";
                item += "Longitud Foto Detalle: " + cursor.getString(16) + "\r\n";
                item += "Observacion: " + cursor.getString(17) + "\r\n";
                item += "Latitud punto 1: " + cursor.getString(18) + "\r\n";
                item += "Longitud punto 1: " + cursor.getString(19) + "\r\n";
                item += "Latitud punto 2: " + cursor.getString(20) + "\r\n";
                item += "Longitud punto 2: " + cursor.getString(21) + "\r\n";
                item += "Latitud punto 3: " + cursor.getString(22) + "\r\n";
                item += "Longitud punto 3: " + cursor.getString(23) + "\r\n";
                item += "Latitud punto 4: " + cursor.getString(24) + "\r\n";
                item += "Longitud punto 4: " + cursor.getString(25) + "\r\n";
                item += "Latitud punto 5: " + cursor.getString(26) + "\r\n";
                item += "Longitud punto 5: " + cursor.getString(27) + "\r\n";
                item += "Latitud punto 6: " + cursor.getString(28) + "\r\n";
                item += "Longitud punto 6: " + cursor.getString(29) + "\r\n";
                item += "Latitud punto 7: " + cursor.getString(30) + "\r\n";
                item += "Longitud punto 7: " + cursor.getString(31) + "\r\n";
                item += "Latitud punto 8: " + cursor.getString(32) + "\r\n";
                item += "Longitud punto 8: " + cursor.getString(33) + "\r\n";
                item += "Latitud punto 9: " + cursor.getString(34) + "\r\n";
                item += "Longitud punto 9: " + cursor.getString(35) + "\r\n";
                item += "Latitud punto 10: " + cursor.getString(36) + "\r\n";
                item += "Longitud punto 10: " + cursor.getString(37) + "";
                listData.add( item );
                item="";
